...
export default function AfterLogin({ props, route }) {
    ...
    return (
        <>
            <Drawer.Navigator drawerContent={(props) => <CustomeDrawer cage={myObject.key1} rewData={uemail} type={type} Udetails={uemail} {...props}></CustomeDrawer>} initialRouteName={iniScreen}>
